        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <h3 className="text-xl font-bold">College Project Showcase</h3>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Showcasing innovative student projects and fostering creativity in technology and research.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">info@college.edu</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-2 md:space-y-0">
            <p className="text-gray-400 text-sm">
              © 2024 College Project Showcase. All rights reserved.
            </p>
