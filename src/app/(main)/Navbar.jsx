...
const {id} = useParams();
  ...
  return (
    <>
  {/* ========== HEADER ========== */}
  <header className="bg-blue-100 border-b border-gray-200 dark:bg-nuetral-80 bg-gray-300 dark:border-neutral-700 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full">
      ...
      >
        <div className="overflow-hidden overflow-y-auto max-h-[75vh] [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-full [&::-webkit-scrollbar-track]:bg-gray-100 [&::-webkit-scrollbar-thumb]:bg-gray-300 dark:[&::-webkit-scrollbar-track]:bg-neutral-700 dark:[&::-webkit-scrollbar-thumb]:bg-neutral-500">
          <div className="py-2 md:py-0 flex flex-col md:flex-row md:items-center md:justify-end gap-0.5 md:gap-1">
            <Link
              className="p-2 flex items-center text-sm text-gray-800  focus:outline-none focus:text-blue-600 dark:text-blue-500 dark:focus:text-blue-500"
              href="/about"
              aria-current="page"
            >
              <svg
            ...
            <Link
              className="p-2 flex items-center text-sm text-gray-800 focus:outline-none focus:text-blue-500 dark:text-blue-700 dark:hover:text-blue-500 dark:focus:text-neutral-500"
            ...
            <div className="relative flex flex-wrap items-center gap-x-1.5 md:ps-2.5 mt-1 md:mt-0 md:ms-1.5 before:block before:absolute before:top-1/2 before:-start-px before:w-px before:h-4 before:bg-gray-300 before:-translate-y-1/2 dark:before:bg-neutral-700">          
              <Link
                className="p-2 w-full flex items-center text-sm text-gray-800 focus:outline-none focus:text-blue-500 dark:text-blue-700 dark:hover:text-blue-500 dark:focus:text-neutral-500"
                href="/login"
              >
                <svg
